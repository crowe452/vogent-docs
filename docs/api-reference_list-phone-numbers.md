[Skip to main content](http://docs.vogent.ai/api-reference/list-phone-numbers#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/list-phone-numbers#authorization-authorization)
Authorization
string
header
required
...
#### Query Parameters
[​](http://docs.vogent.ai/api-reference/list-phone-numbers#parameter-limit)
limit
integer
default:100
The maximum number of phone numbers to list.
[​](http://docs.vogent.ai/api-reference/list-phone-numbers#parameter-cursor)
cursor
string
...
[​](http://docs.vogent.ai/api-reference/list-phone-numbers#response-data)
data
object[]
required
Show child attributes
[​](http://docs.vogent.ai/api-reference/list-phone-numbers#response-cursor-one-of-0)
cursor
string | null
required
A cursor you can pass to fetch the next page. If no next page exists, the cursor will be null.
[Update extractor](http://docs.vogent.ai/api-reference/update-extractor)[Get Phone Number](http://docs.vogent.ai/api-reference/get-phone-number)
⌘I
