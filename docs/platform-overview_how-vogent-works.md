[Skip to main content](http://docs.vogent.ai/platform-overview/how-vogent-works#content-area)
...
[SIP Trunking Overview](http://docs.vogent.ai/telephony/sip/overview#sip-trunking-overview)[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[Introduction](http://docs.vogent.ai/introduction#introduction)
⌘I
