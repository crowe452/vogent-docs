[Skip to main content](http://docs.vogent.ai/guides/functions#content-area)
...
[Delete function](http://docs.vogent.ai/api-reference/delete-function)[Update function](http://docs.vogent.ai/api-reference/update-function)[Create a function](http://docs.vogent.ai/api-reference/create-a-function)
⌘I
