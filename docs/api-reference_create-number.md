[Skip to main content](http://docs.vogent.ai/api-reference/create-number#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/create-number#authorization-authorization)
Authorization
string
header
required
...
[​](http://docs.vogent.ai/api-reference/create-number#body-type)
type
enum<string>
required
...
`sip_import`, 
`vogent_sip`
[​](http://docs.vogent.ai/api-reference/create-number#body-purchase-one-of-0)
purchase
object
Required when type is 'purchase'.
Show child attributes
[​](http://docs.vogent.ai/api-reference/create-number#body-sip-import-one-of-0)
sipImport
object
Required when type is 'sip_import'.
Show child attributes
[​](http://docs.vogent.ai/api-reference/create-number#body-vogent-sip-one-of-0)
vogentSip
object
...
[​](http://docs.vogent.ai/api-reference/create-number#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/create-number#response-number)
number
string
required
...
Example:
`"+18001234567"`
[​](http://docs.vogent.ai/api-reference/create-number#response-type)
type
enum<string>
required
Available options: 
`PSTN`, 
`SIP_USERNAME`
[​](http://docs.vogent.ai/api-reference/create-number#response-agent-id-one-of-0)
agentId
string | null
required
The ID of the linked agent, if the phone number is linked to one.
[Update Phone Number](http://docs.vogent.ai/api-reference/update-phone-number)[Search for available numbers](http://docs.vogent.ai/api-reference/search-for-available-numbers)
⌘I
