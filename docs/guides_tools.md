[Skip to main content](http://docs.vogent.ai/guides/tools#content-area)
...
[Prompting Guide](http://docs.vogent.ai/platform-overview/prompting-guide)[Overview](http://docs.vogent.ai/platform-overview/agents/model/overview)[Flow Builder Agent Quickstart](http://docs.vogent.ai/quickstart/flow-builder#flow-builder-agent-quickstart)
⌘I
