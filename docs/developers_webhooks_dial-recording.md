[Skip to main content](http://docs.vogent.ai/developers/webhooks/dial-recording#content-area)
...
On this page
  * [Event Type](http://docs.vogent.ai/developers/webhooks/dial-recording#event-type)
  * [Payload](http://docs.vogent.ai/developers/webhooks/dial-recording#payload)
  * [Example Message](http://docs.vogent.ai/developers/webhooks/dial-recording#example-message)
...
## 
[​](http://docs.vogent.ai/developers/webhooks/dial-recording#event-type)
Event Type
`dial.recording_created`
## 
[​](http://docs.vogent.ai/developers/webhooks/dial-recording#payload)
Payload
...
## 
[​](http://docs.vogent.ai/developers/webhooks/dial-recording#example-message)
Example Message
Copy
```
{
...
[Dial Status Updated](http://docs.vogent.ai/developers/webhooks/dial-status-updated)[Dial Extractor Complete](http://docs.vogent.ai/developers/webhooks/dial-extractor)
⌘I
