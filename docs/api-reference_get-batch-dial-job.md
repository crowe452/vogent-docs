[Skip to main content](http://docs.vogent.ai/api-reference/get-batch-dial-job#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#parameter-id)
id
string
required
...
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-max-concurrent-dials)
maxConcurrentDials
integer
required
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-status)
status
enum<string>
required
Available options: 
...
`COMPLETE`, 
`CANCELLED`
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-call-agent-id)
callAgentId
string
required
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-created-at)
createdAt
string<date-time>
required
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](http://docs.vogent.ai/api-reference/get-batch-dial-job#response-schedule-one-of-0)
schedule
object
Show child attributes
[Create Batch Job](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job)[Update Batch Job](http://docs.vogent.ai/api-reference/update-batch-dial-job)
⌘I
