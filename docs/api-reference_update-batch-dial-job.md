[Skip to main content](http://docs.vogent.ai/api-reference/update-batch-dial-job#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#parameter-id)
id
string
required
...
#### Body
application/json
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#body-max-concurrent-dials)
maxConcurrentDials
integer
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#body-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#body-schedule-one-of-0)
schedule
object
...
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-max-concurrent-dials)
maxConcurrentDials
integer
required
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-status)
status
enum<string>
required
Available options: 
...
`COMPLETE`, 
`CANCELLED`
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-call-agent-id)
callAgentId
string
required
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-created-at)
createdAt
string<date-time>
required
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](http://docs.vogent.ai/api-reference/update-batch-dial-job#response-schedule-one-of-0)
schedule
object
Show child attributes
[Get Batch Job](http://docs.vogent.ai/api-reference/get-batch-dial-job)[List Queued Batch Dials](http://docs.vogent.ai/api-reference/list-queued-dials-for-batch-dial-job)
⌘I
