[Skip to main content](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#body-call-agent-id)
callAgentId
string
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#body-max-concurrent-dials)
maxConcurrentDials
integer
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#body-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#body-rows)
rows
object[]
required
Show child attributes
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#body-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#body-schedule-one-of-0)
schedule
object
Show child attributes
#### Response
...
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-max-concurrent-dials)
maxConcurrentDials
integer
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-status)
status
enum<string>
required
Available options: 
...
`COMPLETE`, 
`CANCELLED`
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-call-agent-id)
callAgentId
string
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-created-at)
createdAt
string<date-time>
required
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](http://docs.vogent.ai/api-reference/create-a-new-batch-dial-job#response-schedule-one-of-0)
schedule
object
Show child attributes
[List Batch Jobs](http://docs.vogent.ai/api-reference/list-batch-dial-jobs)[Get Batch Job](http://docs.vogent.ai/api-reference/get-batch-dial-job)
⌘I
