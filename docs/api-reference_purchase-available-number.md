[Skip to main content](http://docs.vogent.ai/api-reference/purchase-available-number#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/purchase-available-number#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](http://docs.vogent.ai/api-reference/purchase-available-number#body-number)
number
string
required
...
[​](http://docs.vogent.ai/api-reference/purchase-available-number#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/purchase-available-number#response-number)
number
string
required
...
Example:
`"+18001234567"`
[​](http://docs.vogent.ai/api-reference/purchase-available-number#response-type)
type
enum<string>
required
Available options: 
`PSTN`, 
`SIP_USERNAME`
[​](http://docs.vogent.ai/api-reference/purchase-available-number#response-agent-id-one-of-0)
agentId
string | null
required
The ID of the linked agent, if the phone number is linked to one.
[Search for available numbers](http://docs.vogent.ai/api-reference/search-for-available-numbers)[Delete Phone Number](http://docs.vogent.ai/api-reference/delete-phone-number)
⌘I
