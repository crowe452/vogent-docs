[Skip to main content](http://docs.vogent.ai/api-reference/get-versioned-prompt#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#parameter-agent-id)
agentId
string
required
ID of the agent.
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#parameter-id)
id
string
required
...
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#response-id)
id
string
required
Unique identifier for the versioned prompt
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#response-name)
name
string
required
Human-readable name for the versioned prompt
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#response-agent-type)
agentType
enum<string>
required
...
`STANDARD`, 
`CUSTOM_FLOW`
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#response-prompt-one-of-0)
prompt
string | null
required
The actual prompt content that will be used by the agent. Can be null for CUSTOM_FLOW agent types
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#response-flow-definition-one-of-0)
flowDefinition
object
The flow definition for the agent. Only defined for CUSTOM_FLOW agent types.
Show child attributes
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#response-ai-model-id)
aiModelId
string
The AI model ID to use for the agent.
[​](http://docs.vogent.ai/api-reference/get-versioned-prompt#response-model-option-values)
modelOptionValues
object[]
Show child attributes
[List versioned prompts](http://docs.vogent.ai/api-reference/list-versioned-prompts)[Update versioned prompt](http://docs.vogent.ai/api-reference/update-versioned-prompt)
⌘I
