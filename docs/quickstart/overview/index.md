[Skip to main content](https://docs.vogent.ai/quickstart/overview#content-area)
...
On this page
  * [Getting Started](https://docs.vogent.ai/quickstart/overview#getting-started)
...
## 
[​](https://docs.vogent.ai/quickstart/overview#getting-started)
Getting Started
1
Create an account
...
## [Inbound Agent QuickstartCreate an inbound voice agent that can take orders for a restaurant.](https://docs.vogent.ai/quickstart/inbound)## [Outbound Agent QuickstartCreate an outbound voice agent that can navigate an IVR and speak to airline customer support.](https://docs.vogent.ai/quickstart/outbound)## [Flow Builder Agent QuickstartCreate an inbound voice agent that can ask a series of questions and probe for satisfactory answers.](https://docs.vogent.ai/quickstart/flow-builder)
[Introduction](https://docs.vogent.ai/introduction)[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound)
⌘I
