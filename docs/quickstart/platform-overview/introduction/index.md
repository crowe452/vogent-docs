[Skip to main content](https://docs.vogent.ai/quickstart/platform-overview/introduction#content-area)
...
[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)[Outbound Agent Quickstart](https://docs.vogent.ai/quickstart/outbound#outbound-agent-quickstart)[Flow Builder Agent Quickstart](https://docs.vogent.ai/quickstart/flow-builder)
⌘I
