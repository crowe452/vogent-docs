[Skip to main content](https://docs.vogent.ai/quickstart/outbound#content-area)
...
On this page
  * [The agent](https://docs.vogent.ai/quickstart/outbound#the-agent)
  * [Creating a new agent](https://docs.vogent.ai/quickstart/outbound#creating-a-new-agent)
  * [Configuring the agent](https://docs.vogent.ai/quickstart/outbound#configuring-the-agent)
  * [Prompting the agent](https://docs.vogent.ai/quickstart/outbound#prompting-the-agent)
  * [The IVR Model](https://docs.vogent.ai/quickstart/outbound#the-ivr-model)
  * [The Conversational Model](https://docs.vogent.ai/quickstart/outbound#the-conversational-model)
  * [Retrieving the hours post-call](https://docs.vogent.ai/quickstart/outbound#retrieving-the-hours-post-call)
  * [Making a call](https://docs.vogent.ai/quickstart/outbound#making-a-call)
  * [Phone call](https://docs.vogent.ai/quickstart/outbound#phone-call)
  * [Web call](https://docs.vogent.ai/quickstart/outbound#web-call)
  * [Viewing past calls](https://docs.vogent.ai/quickstart/outbound#viewing-past-calls)
  * [Testing new version on past calls](https://docs.vogent.ai/quickstart/outbound#testing-new-version-on-past-calls)
  * [Conclusion](https://docs.vogent.ai/quickstart/outbound#conclusion)
...
## 
[​](https://docs.vogent.ai/quickstart/outbound#prompting-the-agent)
Prompting the agent
Click on the **Model** tab to see the language model configuration for this agent. This specific agent comprises both an IVR navigation model and a conversational model. The IVR model triggers when Vogent detects that a line is from an IVR; once it detects a human line, it switches irreversibly to the conversational model. See the [IVR Settings](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings) section for more information. You can view each model by going to the **Version** dropdown and selecting `ivr-version` or `conversational-version`.
### 
[​](https://docs.vogent.ai/quickstart/outbound#the-ivr-model)
The IVR Model
...
### 
[​](https://docs.vogent.ai/quickstart/outbound#the-conversational-model)
...
For more information on prompting agents and choosing a base model, see the [prompting agents](https://docs.vogent.ai/guides/prompting-agents) guide.
## 
[​](https://docs.vogent.ai/quickstart/outbound#retrieving-the-hours-post-call)
Retrieving the hours post-call
After the call is completed, you can retrieve the hours from the call using the [Dial Extractor webhook](https://docs.vogent.ai/webhooks/dial-extractor). The webhook will return the extracted hours in the format defined within the agent’s **Extractor** tab. You can also view the extracted hours by clicking on the dial in the agent’s **Dials** tab, or in the **Dial History** tab in the left sidebar. For this particular agent, we’ve defined the following extractor fields:
...
Thus, after every call, Vogent’s extractor model will parse the transcript for the `opening_time` and `closing_time` fields, and store them in the dial. For more information on how to define extractors and use them effectively, see the [extractors](https://docs.vogent.ai/guides/extractors) guide.
## 
[​](https://docs.vogent.ai/quickstart/outbound#making-a-call)
Making a call
### 
[​](https://docs.vogent.ai/quickstart/outbound#phone-call)
Phone call
To make a phone call from an outbound agent, you’ll first need to create a phone number; see the [getting started](https://docs.vogent.ai/quickstart/overview) guide for more information. You can then follow these steps:
1
Open the call modal
...
### 
[​](https://docs.vogent.ai/quickstart/outbound#web-call)
Web call
To make a web call, you can follow the steps above; just toggle to **Web** instead of **Phone**.
## 
[​](https://docs.vogent.ai/quickstart/outbound#viewing-past-calls)
Viewing past calls
...
### 
[​](https://docs.vogent.ai/quickstart/outbound#testing-new-version-on-past-calls)
...
## 
[​](https://docs.vogent.ai/quickstart/outbound#conclusion)
Conclusion
In this quickstart, we’ve walked through the creation of an outbound agent that can navigate an IVR and get a restaurant’s hours. We’ve also covered how to define extractors and use them effectively. This was a cursory overview of the different components of Vogent that can be used to create an outbound agent. To go further in depth on any of these features, or to understand functionality not covered here, see the [platform overview](https://docs.vogent.ai/overview) guide. You can also check out some of our other quickstart guides for different agent types:
  * [Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound)
  * [Survey Agent Quickstart](https://docs.vogent.ai/quickstart/survey)


[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound)[Flow Builder Agent Quickstart](https://docs.vogent.ai/quickstart/flow-builder)
⌘I
