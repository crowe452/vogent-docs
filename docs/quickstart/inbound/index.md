[Skip to main content](https://docs.vogent.ai/quickstart/inbound#content-area)
...
On this page
  * [The agent](https://docs.vogent.ai/quickstart/inbound#the-agent)
  * [Creating a new agent](https://docs.vogent.ai/quickstart/inbound#creating-a-new-agent)
  * [Configuring the agent](https://docs.vogent.ai/quickstart/inbound#configuring-the-agent)
  * [Prompting the agent](https://docs.vogent.ai/quickstart/inbound#prompting-the-agent)
  * [Calculating the total using function-calling](https://docs.vogent.ai/quickstart/inbound#calculating-the-total-using-function-calling)
  * [Retrieving the order post-call](https://docs.vogent.ai/quickstart/inbound#retrieving-the-order-post-call)
  * [Making a call](https://docs.vogent.ai/quickstart/inbound#making-a-call)
  * [Phone call](https://docs.vogent.ai/quickstart/inbound#phone-call)
  * [Web call](https://docs.vogent.ai/quickstart/inbound#web-call)
  * [Viewing past calls](https://docs.vogent.ai/quickstart/inbound#viewing-past-calls)
  * [Testing new version on past calls](https://docs.vogent.ai/quickstart/inbound#testing-new-version-on-past-calls)
  * [Conclusion](https://docs.vogent.ai/quickstart/inbound#conclusion)


Quickstart
# Inbound Agent Quickstart
Create an inbound voice agent that can take orders for a restaurant.
In this quickstart, we’ll create an inbound voice agent that can take orders for a restaurant and calculate the total cost of the order. This guide will provide an overview of the platform by walking through the creation of a sample agent; for a more in-depth guide to using Vogent, see the [platform overview](https://docs.vogent.ai/platform-overview/introduction) guide.
Before you go through this guide, make sure to [create an account](https://docs.vogent.ai/quickstart/overview).
## 
[​](https://docs.vogent.ai/quickstart/inbound#the-agent)
The agent
...
## 
[​](https://docs.vogent.ai/quickstart/inbound#creating-a-new-agent)
...
## 
[​](https://docs.vogent.ai/quickstart/inbound#configuring-the-agent)
...
## 
[​](https://docs.vogent.ai/quickstart/inbound#prompting-the-agent)
Prompting the agent
Click on the **Model** tab to see the language model configuration for this agent. This specific agent is a prompted agent on top of GPT-4o. For more information on prompting agents and choosing a base model, see the [prompting agents](https://docs.vogent.ai/platform-overview/prompting-guide) guide.
Prompt
...
## 
[​](https://docs.vogent.ai/quickstart/inbound#calculating-the-total-using-function-calling)
...
Alternatively, you can define your extractor output field-by-field. For more information on how to define extractors, see the [extractors](https://docs.vogent.ai/guides/extractors) guide.
## 
[​](https://docs.vogent.ai/quickstart/inbound#making-a-call)
Making a call
### 
[​](https://docs.vogent.ai/quickstart/inbound#phone-call)
Phone call
...
### 
[​](https://docs.vogent.ai/quickstart/inbound#web-call)
Web call
...
## 
[​](https://docs.vogent.ai/quickstart/inbound#viewing-past-calls)
Viewing past calls
...
### 
[​](https://docs.vogent.ai/quickstart/inbound#testing-new-version-on-past-calls)
