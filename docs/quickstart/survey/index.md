[Skip to main content](https://docs.vogent.ai/quickstart/survey#content-area)
...
[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound)[Outbound Agent Quickstart](https://docs.vogent.ai/quickstart/outbound)[Flow Builder Agent Quickstart](https://docs.vogent.ai/quickstart/flow-builder)
⌘I
Assistant
