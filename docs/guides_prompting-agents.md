[Skip to main content](http://docs.vogent.ai/guides/prompting-agents#content-area)
...
[Prompting Guide](http://docs.vogent.ai/platform-overview/prompting-guide)[Prompted Models](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#prompted-models)[Overview](http://docs.vogent.ai/platform-overview/agents/model/overview)
⌘I
