[Skip to main content](http://docs.vogent.ai/api-reference/hangup-dial#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/hangup-dial#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/hangup-dial#parameter-id)
id
string
required
ID of the dial.
...
[​](http://docs.vogent.ai/api-reference/hangup-dial#response-success)
success
boolean
required
Example:
`true`
[Create a new dial](http://docs.vogent.ai/api-reference/create-a-new-dial)[Get Dial](http://docs.vogent.ai/api-reference/get-dial)
⌘I
