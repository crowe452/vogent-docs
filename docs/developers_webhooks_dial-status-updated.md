[Skip to main content](http://docs.vogent.ai/developers/webhooks/dial-status-updated#content-area)
...
On this page
  * [Event Type](http://docs.vogent.ai/developers/webhooks/dial-status-updated#event-type)
  * [Payload](http://docs.vogent.ai/developers/webhooks/dial-status-updated#payload)
  * [Example Message](http://docs.vogent.ai/developers/webhooks/dial-status-updated#example-message)
...
## 
[​](http://docs.vogent.ai/developers/webhooks/dial-status-updated#event-type)
Event Type
`dial.updated`
## 
[​](http://docs.vogent.ai/developers/webhooks/dial-status-updated#payload)
Payload
...
## 
[​](http://docs.vogent.ai/developers/webhooks/dial-status-updated#example-message)
Example Message
Copy
```
{
...
[Inbound Dial](http://docs.vogent.ai/developers/webhooks/dial-inbound)[Dial Recording Complete](http://docs.vogent.ai/developers/webhooks/dial-recording)
⌘I
