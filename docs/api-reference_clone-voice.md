[Skip to main content](http://docs.vogent.ai/api-reference/clone-voice#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/clone-voice#authorization-authorization)
Authorization
string
header
required
...
#### Body
multipart/form-data
[​](http://docs.vogent.ai/api-reference/clone-voice#body-name)
name
string
required
The name of the cloned voice.
[​](http://docs.vogent.ai/api-reference/clone-voice#body-clip)
clip
file
required
The audio clip to use for cloning.
[​](http://docs.vogent.ai/api-reference/clone-voice#body-model)
model
enum<string>
required
Available options: 
`CARTESIA`, 
`CSM`
[​](http://docs.vogent.ai/api-reference/clone-voice#body-transcription)
transcription
string
...
[​](http://docs.vogent.ai/api-reference/clone-voice#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/clone-voice#response-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/clone-voice#response-voice-type)
voiceType
string
required
[​](http://docs.vogent.ai/api-reference/clone-voice#response-voice-tier)
voiceTier
enum<string>
required
Available options: 
`STANDARD`, 
`PREMIUM`
[​](http://docs.vogent.ai/api-reference/clone-voice#response-description)
description
string
required
[Delete Agent](http://docs.vogent.ai/api-reference/delete-agent)[List Voices](http://docs.vogent.ai/api-reference/list-voices)
⌘I
