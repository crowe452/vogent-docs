[Skip to main content](http://docs.vogent.ai/api-reference/list-extractors#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/list-extractors#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/list-extractors#parameter-agent-id)
agentId
string
required
ID of the agent.
...
[​](http://docs.vogent.ai/api-reference/list-extractors#response-extractors)
extractors
object[]
required
Show child attributes
[Get extractor](http://docs.vogent.ai/api-reference/get-extractor)[Create extractor](http://docs.vogent.ai/api-reference/create-extractor)
⌘I
