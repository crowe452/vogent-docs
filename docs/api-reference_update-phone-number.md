[Skip to main content](http://docs.vogent.ai/api-reference/update-phone-number#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/update-phone-number#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/update-phone-number#parameter-id)
id
string
required
...
[​](http://docs.vogent.ai/api-reference/update-phone-number#body-agent-id)
agentId
string
...
[​](http://docs.vogent.ai/api-reference/update-phone-number#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/update-phone-number#response-number)
number
string
required
...
Example:
`"+18001234567"`
[​](http://docs.vogent.ai/api-reference/update-phone-number#response-type)
type
enum<string>
required
Available options: 
`PSTN`, 
`SIP_USERNAME`
[​](http://docs.vogent.ai/api-reference/update-phone-number#response-agent-id-one-of-0)
agentId
string | null
required
The ID of the linked agent, if the phone number is linked to one.
[Get Phone Number](http://docs.vogent.ai/api-reference/get-phone-number)[Create a phone number](http://docs.vogent.ai/api-reference/create-number)
⌘I
