[Skip to main content](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#content-area)
...
##### Platform Overview
  ...
  * Agents
    ...
    * Configuration
    * Model
      * [Overview](http://docs.vogent.ai/platform-overview/agents/model/overview)
      * [Prompted Models](http://docs.vogent.ai/platform-overview/agents/model/prompted-models)
      * [Flow Builder](http://docs.vogent.ai/platform-overview/agents/model/flow-builder)
      * [Fine Tuning](http://docs.vogent.ai/platform-overview/agents/model/fine-tuning)
    * Post-Call Analysis
  * Voices
  * Tools
...
On this page
  * [Key Features](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#key-features)
  * [Getting Started](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#getting-started)
  * [Choosing the Right Model](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#choosing-the-right-model)
  * [Third-Party Models](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#third-party-models)
  * [Vogent Base Conversations Model](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#vogent-base-conversations-model)
  * [Writing Effective Prompts](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#writing-effective-prompts)
  * [When to Use Prompted Models](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#when-to-use-prompted-models)
  * [Example Implementation](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#example-implementation)
  * [Next Steps](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#next-steps)
...
## 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#key-features)
Key Features
...
## 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#getting-started)
Getting Started
...
## 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#choosing-the-right-model)
Choosing the Right Model
### 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#third-party-models)
Third-Party Models
Vogent offers off-the-shelf models, like GPT-4o.
### 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#vogent-base-conversations-model)
...
## 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#writing-effective-prompts)
Writing Effective Prompts
For guidance on creating effective prompts, check out our [prompting guide](http://docs.vogent.ai/platform-overview/agents/model/prompted-models). The guide covers:
...
## 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#when-to-use-prompted-models)
...
For more structured interactions like surveys or form-filling, consider using our [Flow Builder](http://docs.vogent.ai/platform-overview/agents/model/flow-builder) instead.
## 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#example-implementation)
...
## 
[​](http://docs.vogent.ai/platform-overview/agents/model/prompted-models#next-steps)
Next Steps
  * Explore our [prompting guide](http://docs.vogent.ai/platform-overview/agents/model/prompted-models) for detailed tips
...
[Overview](http://docs.vogent.ai/platform-overview/agents/model/overview)[Flow Builder](http://docs.vogent.ai/platform-overview/agents/model/flow-builder)
⌘I
