[Skip to main content](https://docs.vogent.ai/guides/counterfactuals#content-area)
...
[Dial History](https://docs.vogent.ai/platform-overview/agents/evaluation/dial-history#counterfactuals)[Outbound Agent Quickstart](https://docs.vogent.ai/quickstart/outbound#testing-new-version-on-past-calls)[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound#testing-new-version-on-past-calls)
⌘I
