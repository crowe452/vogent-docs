[Skip to main content](https://docs.vogent.ai/guides/functions#content-area)
...
[Delete function](https://docs.vogent.ai/api-reference/delete-function)[Update function](https://docs.vogent.ai/api-reference/update-function)[Create a function](https://docs.vogent.ai/api-reference/create-a-function)
⌘I
