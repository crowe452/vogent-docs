[Skip to main content](https://docs.vogent.ai/guides/extractors#content-area)
...
[Extractors](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#extractors)[List extractors](https://docs.vogent.ai/api-reference/list-extractors)[Dial Extractor Complete](https://docs.vogent.ai/developers/webhooks/dial-extractor#dial-extractor-complete)
⌘I
