[Skip to main content](http://docs.vogent.ai/api-reference/get-dial-token#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/get-dial-token#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/get-dial-token#parameter-id)
id
string
required
ID of the dial.
...
[​](http://docs.vogent.ai/api-reference/get-dial-token#response-dial-token)
dialToken
string
required
...
[Get Dial](http://docs.vogent.ai/api-reference/get-dial)[List Agents](http://docs.vogent.ai/api-reference/list-agents)
⌘I
