[Skip to main content](http://docs.vogent.ai/platform-overview/self-learning/create#content-area)
...
On this page
  * [Creating a new agent](http://docs.vogent.ai/platform-overview/self-learning/create#creating-a-new-agent)
  * [Guidelines for Recordings/Transcripts](http://docs.vogent.ai/platform-overview/self-learning/create#guidelines-for-recordings%2Ftranscripts)
  * [PII](http://docs.vogent.ai/platform-overview/self-learning/create#pii)
  * [Human Agent Accuracy](http://docs.vogent.ai/platform-overview/self-learning/create#human-agent-accuracy)
  * [Recordings vs Transcripts](http://docs.vogent.ai/platform-overview/self-learning/create#recordings-vs-transcripts)
  * [Data Size](http://docs.vogent.ai/platform-overview/self-learning/create#data-size)
  * [Guidelines for Talk Tracks](http://docs.vogent.ai/platform-overview/self-learning/create#guidelines-for-talk-tracks)
...
## 
[​](http://docs.vogent.ai/platform-overview/self-learning/create#creating-a-new-agent)
...
## 
[​](http://docs.vogent.ai/platform-overview/self-learning/create#guidelines-for-recordings/transcripts)
...
### 
[​](http://docs.vogent.ai/platform-overview/self-learning/create#pii)
PII
...
### 
[​](http://docs.vogent.ai/platform-overview/self-learning/create#human-agent-accuracy)
...
### 
[​](http://docs.vogent.ai/platform-overview/self-learning/create#recordings-vs-transcripts)
...
### 
[​](http://docs.vogent.ai/platform-overview/self-learning/create#data-size)
Data Size
...
## 
[​](http://docs.vogent.ai/platform-overview/self-learning/create#guidelines-for-talk-tracks)
...
[Self Learning Overview](http://docs.vogent.ai/platform-overview/self-learning/overview)[Optimize Agents](http://docs.vogent.ai/platform-overview/self-learning/optimize)
⌘I
