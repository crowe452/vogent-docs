[Skip to main content](http://docs.vogent.ai/api-reference/create-extractor#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/create-extractor#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/create-extractor#parameter-agent-id)
agentId
string
required
ID of the agent.
...
[​](http://docs.vogent.ai/api-reference/create-extractor#body-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/create-extractor#body-extractor-fields-json-schema)
...
[​](http://docs.vogent.ai/api-reference/create-extractor#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/create-extractor#response-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/create-extractor#response-extractor-fields-json-schema)
extractorFieldsJsonSchema
string
required
[List extractors](http://docs.vogent.ai/api-reference/list-extractors)[Update extractor](http://docs.vogent.ai/api-reference/update-extractor)
⌘I
