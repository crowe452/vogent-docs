[Skip to main content](http://docs.vogent.ai/guides/extractors#content-area)
...
[Extractors](http://docs.vogent.ai/platform-overview/agents/evaluation/extractors#extractors)[List extractors](http://docs.vogent.ai/api-reference/list-extractors)[Dial Extractor Complete](http://docs.vogent.ai/developers/webhooks/dial-extractor#dial-extractor-complete)
⌘I
