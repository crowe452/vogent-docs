[Skip to main content](http://docs.vogent.ai/platform-overview/agents/model/function-calling#content-area)
...
[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[Function Calling](http://docs.vogent.ai/platform-overview/tools/function-calling)[Inbound Agent Quickstart](http://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)
⌘I
