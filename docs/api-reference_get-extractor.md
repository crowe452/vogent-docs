[Skip to main content](http://docs.vogent.ai/api-reference/get-extractor#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/get-extractor#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/get-extractor#parameter-agent-id)
agentId
string
required
ID of the agent.
[​](http://docs.vogent.ai/api-reference/get-extractor#parameter-extractor-id)
extractorId
string
required
ID of the extractor.
...
[​](http://docs.vogent.ai/api-reference/get-extractor#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/get-extractor#response-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/get-extractor#response-extractor-fields-json-schema)
extractorFieldsJsonSchema
string
required
[Create versioned prompt](http://docs.vogent.ai/api-reference/create-versioned-prompt)[List extractors](http://docs.vogent.ai/api-reference/list-extractors)
⌘I
