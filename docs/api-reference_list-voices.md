[Skip to main content](http://docs.vogent.ai/api-reference/list-voices#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/list-voices#authorization-authorization)
Authorization
string
header
required
...
#### Query Parameters
[​](http://docs.vogent.ai/api-reference/list-voices#parameter-name)
name
string
Filter voices by name.
[​](http://docs.vogent.ai/api-reference/list-voices#parameter-voice-type)
voiceType
string
The provider (for third party voices), or model type (for Vogent hosted voices).
[​](http://docs.vogent.ai/api-reference/list-voices#parameter-limit)
limit
integer
The maximum number of voices to return.
[​](http://docs.vogent.ai/api-reference/list-voices#parameter-cursor)
cursor
string
...
[​](http://docs.vogent.ai/api-reference/list-voices#response-voices)
voices
object[]
required
Show child attributes
[​](http://docs.vogent.ai/api-reference/list-voices#response-cursor-one-of-0)
cursor
string | null
required
A cursor you can pass to /voices to fetch the next page. If no next page exists, the cursor will be null.
[Clone Voice](http://docs.vogent.ai/api-reference/clone-voice)[List versioned prompts](http://docs.vogent.ai/api-reference/list-versioned-prompts)
⌘I
