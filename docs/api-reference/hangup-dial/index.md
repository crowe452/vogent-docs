[Skip to main content](https://docs.vogent.ai/api-reference/hangup-dial#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/hangup-dial#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/hangup-dial#parameter-id)
id
string
required
ID of the dial.
...
[​](https://docs.vogent.ai/api-reference/hangup-dial#response-success)
success
boolean
required
Example:
`true`
[Create a new dial](https://docs.vogent.ai/api-reference/create-a-new-dial)[Get Dial](https://docs.vogent.ai/api-reference/get-dial)
⌘I
