[Skip to main content](https://docs.vogent.ai/api-reference/purchase-available-number#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/purchase-available-number#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](https://docs.vogent.ai/api-reference/purchase-available-number#body-number)
number
string
required
...
[​](https://docs.vogent.ai/api-reference/purchase-available-number#response-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/purchase-available-number#response-number)
number
string
required
...
Example:
`"+18001234567"`
[​](https://docs.vogent.ai/api-reference/purchase-available-number#response-type)
type
enum<string>
required
Available options: 
`PSTN`, 
`SIP_USERNAME`
[​](https://docs.vogent.ai/api-reference/purchase-available-number#response-agent-id-one-of-0)
agentId
string | null
required
The ID of the linked agent, if the phone number is linked to one.
[Search for available numbers](https://docs.vogent.ai/api-reference/search-for-available-numbers)[Delete Phone Number](https://docs.vogent.ai/api-reference/delete-phone-number)
⌘I
