[Skip to main content](https://docs.vogent.ai/api-reference/create-extractor#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/create-extractor#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/create-extractor#parameter-agent-id)
agentId
string
required
ID of the agent.
...
[​](https://docs.vogent.ai/api-reference/create-extractor#body-name)
name
string
required
[​](https://docs.vogent.ai/api-reference/create-extractor#body-extractor-fields-json-schema)
...
[​](https://docs.vogent.ai/api-reference/create-extractor#response-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/create-extractor#response-name)
name
string
required
[​](https://docs.vogent.ai/api-reference/create-extractor#response-extractor-fields-json-schema)
extractorFieldsJsonSchema
string
required
[List extractors](https://docs.vogent.ai/api-reference/list-extractors)[Update extractor](https://docs.vogent.ai/api-reference/update-extractor)
⌘I
