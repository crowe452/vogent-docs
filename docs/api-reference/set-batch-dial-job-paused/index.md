[Skip to main content](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#content-area)
...
```
curl --request POST \
 --url https://api.vogent.ai/api/batch_dial_jobs/{id}/paused \
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#parameter-id)
id
string
required
...
#### Body
application/json
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#body-paused)
paused
boolean
required
#### Response
...
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-max-concurrent-dials)
maxConcurrentDials
integer
required
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-name)
name
string
required
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-status)
status
enum<string>
required
Available options: 
...
`COMPLETE`, 
`CANCELLED`
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-call-agent-id)
callAgentId
string
required
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-created-at)
createdAt
string<date-time>
required
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-schedule-one-of-0)
schedule
object
Show child attributes
[List Queued Batch Dials](https://docs.vogent.ai/api-reference/list-queued-dials-for-batch-dial-job)[List Batch Dials](https://docs.vogent.ai/api-reference/list-batch-dials)
⌘I
