[Skip to main content](https://docs.vogent.ai/api-reference/search-for-available-numbers#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/search-for-available-numbers#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](https://docs.vogent.ai/api-reference/search-for-available-numbers#body-prefix)
prefix
string
required
The phone number prefix, without the country code.
[​](https://docs.vogent.ai/api-reference/search-for-available-numbers#body-country)
country
string
default:US
The 2-letter country code.
[​](https://docs.vogent.ai/api-reference/search-for-available-numbers#body-limit)
limit
integer
default:5
...
[​](https://docs.vogent.ai/api-reference/search-for-available-numbers#response-items-number)
number
string
required
The phone number that's available for purchase
[Create a phone number](https://docs.vogent.ai/api-reference/create-number)[Purchase available number (deprecated, use /phone_numbers instead)](https://docs.vogent.ai/api-reference/purchase-available-number)
⌘I
