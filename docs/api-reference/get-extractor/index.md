[Skip to main content](https://docs.vogent.ai/api-reference/get-extractor#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/get-extractor#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/get-extractor#parameter-agent-id)
agentId
string
required
ID of the agent.
[​](https://docs.vogent.ai/api-reference/get-extractor#parameter-extractor-id)
extractorId
string
required
ID of the extractor.
...
[​](https://docs.vogent.ai/api-reference/get-extractor#response-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/get-extractor#response-name)
name
string
required
[​](https://docs.vogent.ai/api-reference/get-extractor#response-extractor-fields-json-schema)
extractorFieldsJsonSchema
string
required
[Create versioned prompt](https://docs.vogent.ai/api-reference/create-versioned-prompt)[List extractors](https://docs.vogent.ai/api-reference/list-extractors)
⌘I
