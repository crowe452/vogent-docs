[Skip to main content](https://docs.vogent.ai/api-reference/list-batch-dials#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/list-batch-dials#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/list-batch-dials#parameter-id)
id
string
required
ID of the batch dial job.
#### Query Parameters
[​](https://docs.vogent.ai/api-reference/list-batch-dials#parameter-limit)
limit
integer
The number of dials to return.
[​](https://docs.vogent.ai/api-reference/list-batch-dials#parameter-cursor)
cursor
string
...
[​](https://docs.vogent.ai/api-reference/list-batch-dials#response-data)
data
object[]
required
Show child attributes
[​](https://docs.vogent.ai/api-reference/list-batch-dials#response-cursor-one-of-0)
cursor
string | null
required
[Pause/Resume Batch Job](https://docs.vogent.ai/api-reference/set-batch-dial-job-paused)
⌘I
