[Skip to main content](https://docs.vogent.ai/api-reference/list-models#content-area)
...
```
curl --request GET \
 --url 'https://api.vogent.ai/api/models?limit=100' \
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/list-models#authorization-authorization)
Authorization
string
header
required
...
#### Query Parameters
[​](https://docs.vogent.ai/api-reference/list-models#parameter-limit)
limit
integer
default:100
The maximum number of records to fetch.
[​](https://docs.vogent.ai/api-reference/list-models#parameter-cursor)
cursor
string
...
[​](https://docs.vogent.ai/api-reference/list-models#response-data)
data
object[]
required
Show child attributes
[​](https://docs.vogent.ai/api-reference/list-models#response-cursor-one-of-0)
cursor
string | null
required
A cursor you can pass to /agents to fetch the next page. If no next page exists, the cursor will be null.
[Delete function](https://docs.vogent.ai/api-reference/delete-function)[Run TTS Model](https://docs.vogent.ai/api-reference/run-tts-model)
⌘I
