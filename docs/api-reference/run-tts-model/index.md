[Skip to main content](https://docs.vogent.ai/api-reference/run-tts-model#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/run-tts-model#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](https://docs.vogent.ai/api-reference/run-tts-model#body-text)
text
string
required
The text to generate.
[​](https://docs.vogent.ai/api-reference/run-tts-model#body-voice-id)
voiceId
string
required
The voice ID to use to generate the text.
[​](https://docs.vogent.ai/api-reference/run-tts-model#body-voice-option-values)
voiceOptionValues
object[]
An optional configuration for the voice being used.
Show child attributes
[​](https://docs.vogent.ai/api-reference/run-tts-model#body-format)
format
object
...
[List Models](https://docs.vogent.ai/api-reference/list-models)[Run Multispeaker TTS Model](https://docs.vogent.ai/api-reference/run-multispeaker-tts-model)
⌘I
