[Skip to main content](https://docs.vogent.ai/api-reference/get-phone-number#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/get-phone-number#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/get-phone-number#parameter-id)
id
string
required
...
[​](https://docs.vogent.ai/api-reference/get-phone-number#response-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/get-phone-number#response-number)
number
string
required
...
Example:
`"+18001234567"`
[​](https://docs.vogent.ai/api-reference/get-phone-number#response-type)
type
enum<string>
required
Available options: 
`PSTN`, 
`SIP_USERNAME`
[​](https://docs.vogent.ai/api-reference/get-phone-number#response-agent-id-one-of-0)
agentId
string | null
required
The ID of the linked agent, if the phone number is linked to one.
[List phone numbers](https://docs.vogent.ai/api-reference/list-phone-numbers)[Update Phone Number](https://docs.vogent.ai/api-reference/update-phone-number)
⌘I
