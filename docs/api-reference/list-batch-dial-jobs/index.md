[Skip to main content](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#authorization-authorization)
Authorization
string
header
required
...
#### Query Parameters
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#parameter-limit)
limit
integer
The number of jobs to return.
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#parameter-cursor)
cursor
string
The cursor for pagination.
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#parameter-status)
status
enum<string>
Available options: 
`INIT`, 
...
`COMPLETE`, 
`CANCELLED`
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#parameter-call-agent-id)
callAgentId
string
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#parameter-user-id)
userId
string
#### Response
200
...
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#response-data)
data
object[]
required
Show child attributes
[​](https://docs.vogent.ai/api-reference/list-batch-dial-jobs#response-cursor-one-of-0)
cursor
string | null
required
[Websocket TTS](https://docs.vogent.ai/api-reference/voicelab-websocket-tts)[Create Batch Job](https://docs.vogent.ai/api-reference/create-a-new-batch-dial-job)
⌘I
