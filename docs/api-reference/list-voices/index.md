[Skip to main content](https://docs.vogent.ai/api-reference/list-voices#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/list-voices#authorization-authorization)
Authorization
string
header
required
...
#### Query Parameters
[​](https://docs.vogent.ai/api-reference/list-voices#parameter-name)
name
string
Filter voices by name.
[​](https://docs.vogent.ai/api-reference/list-voices#parameter-voice-type)
voiceType
string
The provider (for third party voices), or model type (for Vogent hosted voices).
[​](https://docs.vogent.ai/api-reference/list-voices#parameter-limit)
limit
integer
The maximum number of voices to return.
[​](https://docs.vogent.ai/api-reference/list-voices#parameter-cursor)
cursor
string
...
[​](https://docs.vogent.ai/api-reference/list-voices#response-voices)
voices
object[]
required
Show child attributes
[​](https://docs.vogent.ai/api-reference/list-voices#response-cursor-one-of-0)
cursor
string | null
required
A cursor you can pass to /voices to fetch the next page. If no next page exists, the cursor will be null.
[Clone Voice](https://docs.vogent.ai/api-reference/clone-voice)[List versioned prompts](https://docs.vogent.ai/api-reference/list-versioned-prompts)
⌘I
