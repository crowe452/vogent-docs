[Skip to main content](https://docs.vogent.ai/api-reference/list-versioned-prompts#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/list-versioned-prompts#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/list-versioned-prompts#parameter-agent-id)
agentId
string
required
ID of the agent.
#### Query Parameters
[​](https://docs.vogent.ai/api-reference/list-versioned-prompts#parameter-limit)
limit
integer
default:100
The maximum number of prompts to list.
[​](https://docs.vogent.ai/api-reference/list-versioned-prompts#parameter-cursor)
cursor
string
...
[​](https://docs.vogent.ai/api-reference/list-versioned-prompts#response-data)
data
object[]
required
Show child attributes
[​](https://docs.vogent.ai/api-reference/list-versioned-prompts#response-cursor-one-of-0)
cursor
string | null
required
A cursor you can pass to fetch the next page. If no next page exists, the cursor will be null.
[List Voices](https://docs.vogent.ai/api-reference/list-voices)[Get versioned prompt](https://docs.vogent.ai/api-reference/get-versioned-prompt)
⌘I
