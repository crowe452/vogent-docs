[Skip to main content](https://docs.vogent.ai/api-reference/get-dial-token#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/get-dial-token#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/get-dial-token#parameter-id)
id
string
required
ID of the dial.
...
[​](https://docs.vogent.ai/api-reference/get-dial-token#response-dial-token)
dialToken
string
required
...
[Get Dial](https://docs.vogent.ai/api-reference/get-dial)[List Agents](https://docs.vogent.ai/api-reference/list-agents)
⌘I
