[Skip to main content](https://docs.vogent.ai/api-reference/update-batch-dial-job#content-area)
...
Batch Dials
# Update Batch Job
Update an existing batch dial job.
PUT
/
batch_dial_jobs
/
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#parameter-id)
id
string
required
...
#### Body
application/json
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#body-max-concurrent-dials)
maxConcurrentDials
integer
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#body-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#body-schedule-one-of-0)
schedule
object
...
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-max-concurrent-dials)
maxConcurrentDials
integer
required
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-name)
name
string
required
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-status)
status
enum<string>
required
Available options: 
...
`COMPLETE`, 
`CANCELLED`
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-call-agent-id)
callAgentId
string
required
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-created-at)
createdAt
string<date-time>
required
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](https://docs.vogent.ai/api-reference/update-batch-dial-job#response-schedule-one-of-0)
schedule
object
Show child attributes
[Get Batch Job](https://docs.vogent.ai/api-reference/get-batch-dial-job)[List Queued Batch Dials](https://docs.vogent.ai/api-reference/list-queued-dials-for-batch-dial-job)
⌘I
