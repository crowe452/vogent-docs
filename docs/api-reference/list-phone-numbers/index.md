[Skip to main content](https://docs.vogent.ai/api-reference/list-phone-numbers#content-area)
...
```
curl --request GET \
 --url 'https://api.vogent.ai/api/phone_numbers?limit=100' \
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/list-phone-numbers#authorization-authorization)
Authorization
string
header
required
...
#### Query Parameters
[​](https://docs.vogent.ai/api-reference/list-phone-numbers#parameter-limit)
limit
integer
default:100
The maximum number of phone numbers to list.
[​](https://docs.vogent.ai/api-reference/list-phone-numbers#parameter-cursor)
cursor
string
...
[​](https://docs.vogent.ai/api-reference/list-phone-numbers#response-data)
data
object[]
required
Show child attributes
[​](https://docs.vogent.ai/api-reference/list-phone-numbers#response-cursor-one-of-0)
cursor
string | null
required
A cursor you can pass to fetch the next page. If no next page exists, the cursor will be null.
[Update extractor](https://docs.vogent.ai/api-reference/update-extractor)[Get Phone Number](https://docs.vogent.ai/api-reference/get-phone-number)
⌘I
