[Skip to main content](https://docs.vogent.ai/api-reference/update-phone-number#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/update-phone-number#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/update-phone-number#parameter-id)
id
string
required
...
[​](https://docs.vogent.ai/api-reference/update-phone-number#body-agent-id)
agentId
string
...
[​](https://docs.vogent.ai/api-reference/update-phone-number#response-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/update-phone-number#response-number)
number
string
required
...
Example:
`"+18001234567"`
[​](https://docs.vogent.ai/api-reference/update-phone-number#response-type)
type
enum<string>
required
Available options: 
`PSTN`, 
`SIP_USERNAME`
[​](https://docs.vogent.ai/api-reference/update-phone-number#response-agent-id-one-of-0)
agentId
string | null
required
The ID of the linked agent, if the phone number is linked to one.
[Get Phone Number](https://docs.vogent.ai/api-reference/get-phone-number)[Create a phone number](https://docs.vogent.ai/api-reference/create-number)
⌘I
