[Skip to main content](https://docs.vogent.ai/api-reference/create-a-function#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/create-a-function#authorization-authorization)
Authorization
string
header
required
...
[​](https://docs.vogent.ai/api-reference/create-a-function#body-one-of-0-name)
name
string
required
The name of the function.
[​](https://docs.vogent.ai/api-reference/create-a-function#body-one-of-0-description)
description
string
required
A description of what the function does.
[​](https://docs.vogent.ai/api-reference/create-a-function#body-one-of-0-allowed-numbers)
allowedNumbers
object[]
required
The numbers that the agent is allowed to transfer to in e.164 format (+11234567890).
Show child attributes
[​](https://docs.vogent.ai/api-reference/create-a-function#body-one-of-0-type)
type
enum<string>
Available options: 
`transfer`, 
`api`
[​](https://docs.vogent.ai/api-reference/create-a-function#body-one-of-0-lifecycle-messages)
lifecycleMessages
object
Messages to display during function execution lifecycle events.
Show child attributes
[​](https://docs.vogent.ai/api-reference/create-a-function#body-one-of-0-allow-any-number)
allowAnyNumber
boolean
...
[​](https://docs.vogent.ai/api-reference/create-a-function#response-one-of-0-id)
id
string
required
[​](https://docs.vogent.ai/api-reference/create-a-function#response-one-of-0-name)
name
string
required
The name of the function.
[​](https://docs.vogent.ai/api-reference/create-a-function#response-one-of-0-description)
description
string
required
A description of what the function does.
[​](https://docs.vogent.ai/api-reference/create-a-function#response-one-of-0-type)
type
enum<string>
required
Available options: 
`transfer`, 
`api`
[​](https://docs.vogent.ai/api-reference/create-a-function#response-one-of-0-allowed-numbers)
allowedNumbers
object[]
required
The numbers that the agent is allowed to transfer to.
Show child attributes
[​](https://docs.vogent.ai/api-reference/create-a-function#response-one-of-0-allow-any-number)
allowAnyNumber
boolean
required
Instead of using a fixed list of allowed numbers, allow the agent to transfer to any number (not recommended).
[​](https://docs.vogent.ai/api-reference/create-a-function#response-one-of-0-lifecycle-messages)
lifecycleMessages
object
Messages to display during function execution lifecycle events.
Show child attributes
[Delete Phone Number](https://docs.vogent.ai/api-reference/delete-phone-number)[Get function](https://docs.vogent.ai/api-reference/get-function)
⌘I
