[Skip to main content](https://docs.vogent.ai/api-reference/list-extractors#content-area)
...
#### Authorizations
[​](https://docs.vogent.ai/api-reference/list-extractors#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](https://docs.vogent.ai/api-reference/list-extractors#parameter-agent-id)
agentId
string
required
ID of the agent.
...
[​](https://docs.vogent.ai/api-reference/list-extractors#response-extractors)
extractors
object[]
required
Show child attributes
[Get extractor](https://docs.vogent.ai/api-reference/get-extractor)[Create extractor](https://docs.vogent.ai/api-reference/create-extractor)
⌘I
