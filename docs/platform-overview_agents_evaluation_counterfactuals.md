[Skip to main content](http://docs.vogent.ai/platform-overview/agents/evaluation/counterfactuals#content-area)
...
[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[Dial History](http://docs.vogent.ai/platform-overview/agents/evaluation/dial-history#counterfactuals)[Versioning and Evaluation](http://docs.vogent.ai/platform-overview/agents/evaluation/versioning-and-evaluation#versioning-and-evaluation)
⌘I
