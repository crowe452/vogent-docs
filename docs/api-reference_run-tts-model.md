[Skip to main content](http://docs.vogent.ai/api-reference/run-tts-model#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/run-tts-model#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](http://docs.vogent.ai/api-reference/run-tts-model#body-text)
text
string
required
The text to generate.
[​](http://docs.vogent.ai/api-reference/run-tts-model#body-voice-id)
voiceId
string
required
The voice ID to use to generate the text.
[​](http://docs.vogent.ai/api-reference/run-tts-model#body-voice-option-values)
voiceOptionValues
object[]
An optional configuration for the voice being used.
Show child attributes
[​](http://docs.vogent.ai/api-reference/run-tts-model#body-format)
format
object
...
[List Models](http://docs.vogent.ai/api-reference/list-models)[Run Multispeaker TTS Model](http://docs.vogent.ai/api-reference/run-multispeaker-tts-model)
⌘I
