[Skip to main content](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#parameter-id)
id
string
required
...
#### Body
application/json
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#body-paused)
paused
boolean
required
#### Response
...
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-id)
id
string
required
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-max-concurrent-dials)
maxConcurrentDials
integer
required
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-name)
name
string
required
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-status)
status
enum<string>
required
Available options: 
...
`COMPLETE`, 
`CANCELLED`
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-call-agent-id)
callAgentId
string
required
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-created-at)
createdAt
string<date-time>
required
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-from-phone-number-ids)
fromPhoneNumberIds
string[]
[​](http://docs.vogent.ai/api-reference/set-batch-dial-job-paused#response-schedule-one-of-0)
schedule
object
Show child attributes
[List Queued Batch Dials](http://docs.vogent.ai/api-reference/list-queued-dials-for-batch-dial-job)[List Batch Dials](http://docs.vogent.ai/api-reference/list-batch-dials)
⌘I
