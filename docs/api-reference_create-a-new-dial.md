[Skip to main content](http://docs.vogent.ai/api-reference/create-a-new-dial#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#authorization-authorization)
Authorization
string
header
required
...
application/json
Create a new dial
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-call-agent-id)
callAgentId
string
required
...
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-webhook-url-one-of-0)
webhookUrl
string | null
Optional. The URL for the webhook for this dial session.
Example:
`"https://test.com/webhook"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-browser-call-one-of-0)
browserCall
boolean | null
Set to true if this is a browser call.
Example:
`false`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-to-number-one-of-0)
toNumber
string | null
Required if this is a phone dial, in E.164 format.
Example:
`"+11234567890"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-from-number-id-one-of-0)
fromNumberId
string | null
...
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-from-number-pool-id-one-of-0)
fromNumberPoolId
string | null
The ID of a phone number pool to use when starting the call.
Example:
`"1caec78c-4bba-477d-82cf-bcfce2b73856"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-ai-voice-id-one-of-0)
aiVoiceId
string | null
The ID for the voice on the call. If not specified, the default voice for the agent will be used.
Example:
`"61ccefdf-ea02-4f49-811b-1241f8e20d26"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-voice-option-values)
voiceOptionValues
object[]
An optional configuration for the voice being used.
Show child attributes
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-voice-volume-level)
voiceVolumeLevel
integer
The volume level for the voice on the call, from -300 (quiet) to 300 (loud).
Example:
`-100`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-versioned-model-id)
versionedModelId
string
The prompt/model version to use for this call, if not specified, the default on the agent is used.
Example:
`"61ccefdf-ea02-4f49-811b-1241f8e20d26"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-ivr-versioned-prompt-id)
ivrVersionedPromptId
string
The prompt/model version to use for the IVR portion of this call, if ivr nav is enabled on the agent.
Example:
`"61ccefdf-ea02-4f49-811b-1241f8e20d26"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-override-transcriber-final-duration-ms)
...
Example:
`500`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-timeout-minutes)
timeoutMinutes
integer
...
Example:
`10`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-call-agent-extractor-id)
callAgentExtractorId
string
The ID of the extractor to use for this call, if not specified, the default on the agent is used.
Example:
`"61ccefdf-ea02-4f49-811b-1241f8e20d26"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-call-agent-input-one-of-0)
callAgentInput
object
Any macros in the call agent prompt.
Show child attributes
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-agent-overrides-one-of-0)
agentOverrides
object
...
Show child attributes
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-keywords-one-of-0)
keywords
string[] | null
A list of keywords to be used in the call.
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#body-advanced-browser-interaction)
...
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#response-dial-token)
dialToken
string
required
...
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#response-session-id)
sessionId
string
required
Example:
`"61ccefdf-ea02-4f49-811b-1241f8e20d26"`
[​](http://docs.vogent.ai/api-reference/create-a-new-dial#response-dial-id)
dialId
string
required
Example:
`"57555c5e-5a56-49ca-8fe8-24946d2fbc3e"`
[Introduction](http://docs.vogent.ai/api-reference/introduction)[Hangup Dial.](http://docs.vogent.ai/api-reference/hangup-dial)
⌘I
