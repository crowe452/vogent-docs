[Skip to main content](http://docs.vogent.ai/platform-overview/agents/counterfactuals#content-area)
...
[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[Dial History](http://docs.vogent.ai/platform-overview/agents/evaluation/dial-history#counterfactuals)[Inbound Agent Quickstart](http://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)
⌘I
Assistant
