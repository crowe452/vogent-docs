[Skip to main content](https://docs.vogent.ai/telephony/sip/twilio#content-area)
...
On this page
  * [For Outbound Calls](https://docs.vogent.ai/telephony/sip/twilio#for-outbound-calls)
  * [For Inbound Calls](https://docs.vogent.ai/telephony/sip/twilio#for-inbound-calls)
...
## 
[​](https://docs.vogent.ai/telephony/sip/twilio#for-outbound-calls)
For Outbound Calls
...
![](https://mintcdn.com/elto-1/azBE43ot8reGwUsO/images/twilio-sip-transfer.png?fit=max&auto=format&n=azBE43ot8reGwUsO&q=85&s=2340acd05b63e6674e0260c0227cba7d)
  1. In Vogent, Go to the **Call Settings** tab in the left sidebar, and click **Import via SIP** , and enter the termination URI and credentials you created in steps 1-3. You may also do this using the [Create Number API](https://docs.vogent.ai/api-reference/create-number) with `type` set to `sip_import`.
...
## 
[​](https://docs.vogent.ai/telephony/sip/twilio#for-inbound-calls)
For Inbound Calls
...
[SIP Trunking Overview](https://docs.vogent.ai/telephony/sip/overview)[Vonage SIP Import](https://docs.vogent.ai/telephony/sip/vonage)
⌘I
