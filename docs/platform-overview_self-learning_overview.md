[Skip to main content](http://docs.vogent.ai/platform-overview/self-learning/overview#content-area)
...
## [Auto-CreateCreate your agent from recordings and talk tracks](http://docs.vogent.ai/platform-overview/self-learning/create)## [OptimizeAuto-improve your agent’s performance based on historical dials and simulations](http://docs.vogent.ai/platform-overview/self-learning/optimize)
[Using a SIP Domain](http://docs.vogent.ai/telephony/sip-domain/overview)[Auto-Create Agents](http://docs.vogent.ai/platform-overview/self-learning/create)
⌘I
