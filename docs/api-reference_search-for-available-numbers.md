[Skip to main content](http://docs.vogent.ai/api-reference/search-for-available-numbers#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/search-for-available-numbers#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](http://docs.vogent.ai/api-reference/search-for-available-numbers#body-prefix)
prefix
string
required
The phone number prefix, without the country code.
[​](http://docs.vogent.ai/api-reference/search-for-available-numbers#body-country)
country
string
default:US
The 2-letter country code.
[​](http://docs.vogent.ai/api-reference/search-for-available-numbers#body-limit)
limit
integer
default:5
...
[​](http://docs.vogent.ai/api-reference/search-for-available-numbers#response-items-number)
number
string
required
The phone number that's available for purchase
[Create a phone number](http://docs.vogent.ai/api-reference/create-number)[Purchase available number (deprecated, use /phone_numbers instead)](http://docs.vogent.ai/api-reference/purchase-available-number)
⌘I
