[Skip to main content](http://docs.vogent.ai/api-reference/run-multispeaker-tts-model#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/run-multispeaker-tts-model#authorization-authorization)
Authorization
string
header
required
...
#### Body
application/json
[​](http://docs.vogent.ai/api-reference/run-multispeaker-tts-model#body-lines)
lines
object[]
required
The lines that need to be generated.
Show child attributes
[​](http://docs.vogent.ai/api-reference/run-multispeaker-tts-model#body-voice-option-values)
voiceOptionValues
object[]
An optional configuration for the voices being used.
Show child attributes
[​](http://docs.vogent.ai/api-reference/run-multispeaker-tts-model#body-format)
format
object
...
[Run TTS Model](http://docs.vogent.ai/api-reference/run-tts-model)[Websocket TTS](http://docs.vogent.ai/api-reference/voicelab-websocket-tts)
⌘I
