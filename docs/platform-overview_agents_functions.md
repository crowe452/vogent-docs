[Skip to main content](http://docs.vogent.ai/platform-overview/agents/functions#content-area)
...
[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[Inbound Agent Quickstart](http://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)[Outbound Agent Quickstart](http://docs.vogent.ai/quickstart/outbound#outbound-agent-quickstart)
⌘I
