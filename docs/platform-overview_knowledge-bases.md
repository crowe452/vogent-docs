[Skip to main content](http://docs.vogent.ai/platform-overview/knowledge-bases#content-area)
...
[Knowledge Bases](http://docs.vogent.ai/platform-overview/tools/knowledge-bases)[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[SIP Trunking Overview](http://docs.vogent.ai/telephony/sip/overview#sip-trunking-overview)
⌘I
