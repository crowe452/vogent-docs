[Skip to main content](http://docs.vogent.ai/platform-overview/telephony#content-area)
...
[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[SIP Trunking Overview](http://docs.vogent.ai/telephony/sip/overview#sip-trunking-overview)[Introduction](http://docs.vogent.ai/platform-overview/introduction)
⌘I
