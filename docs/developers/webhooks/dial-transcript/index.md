[Skip to main content](https://docs.vogent.ai/developers/webhooks/dial-transcript#content-area)
...
On this page
  * [Event Type](https://docs.vogent.ai/developers/webhooks/dial-transcript#event-type)
  * [Payload](https://docs.vogent.ai/developers/webhooks/dial-transcript#payload)
  * [Example Message](https://docs.vogent.ai/developers/webhooks/dial-transcript#example-message)
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-transcript#event-type)
Event Type
`dial.transcript`
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-transcript#payload)
Payload
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-transcript#example-message)
Example Message
Copy
```
{
...
[Dial Extractor Complete](https://docs.vogent.ai/developers/webhooks/dial-extractor)[Function Call](https://docs.vogent.ai/developers/webhooks/function-call)
⌘I
