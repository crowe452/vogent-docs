[Skip to main content](https://docs.vogent.ai/developers/webhooks/dial-status-updated#content-area)
...
On this page
  * [Event Type](https://docs.vogent.ai/developers/webhooks/dial-status-updated#event-type)
  * [Payload](https://docs.vogent.ai/developers/webhooks/dial-status-updated#payload)
  * [Example Message](https://docs.vogent.ai/developers/webhooks/dial-status-updated#example-message)
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-status-updated#event-type)
Event Type
`dial.updated`
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-status-updated#payload)
Payload
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-status-updated#example-message)
Example Message
Copy
```
{
...
[Inbound Dial](https://docs.vogent.ai/developers/webhooks/dial-inbound)[Dial Recording Complete](https://docs.vogent.ai/developers/webhooks/dial-recording)
⌘I
