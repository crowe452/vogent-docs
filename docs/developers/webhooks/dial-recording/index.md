[Skip to main content](https://docs.vogent.ai/developers/webhooks/dial-recording#content-area)
...
On this page
  * [Event Type](https://docs.vogent.ai/developers/webhooks/dial-recording#event-type)
  * [Payload](https://docs.vogent.ai/developers/webhooks/dial-recording#payload)
  * [Example Message](https://docs.vogent.ai/developers/webhooks/dial-recording#example-message)
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-recording#event-type)
Event Type
`dial.recording_created`
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-recording#payload)
Payload
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-recording#example-message)
Example Message
Copy
```
{
...
[Dial Status Updated](https://docs.vogent.ai/developers/webhooks/dial-status-updated)[Dial Extractor Complete](https://docs.vogent.ai/developers/webhooks/dial-extractor)
⌘I
