[Skip to main content](https://docs.vogent.ai/developers/webhooks/dial-extractor#content-area)
...
On this page
  * [Event Type](https://docs.vogent.ai/developers/webhooks/dial-extractor#event-type)
  * [Payload](https://docs.vogent.ai/developers/webhooks/dial-extractor#payload)
  * [Example Message](https://docs.vogent.ai/developers/webhooks/dial-extractor#example-message)
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-extractor#event-type)
Event Type
`dial.extractor`
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-extractor#payload)
Payload
...
## 
[​](https://docs.vogent.ai/developers/webhooks/dial-extractor#example-message)
Example Message
Copy
```
{
...
[Dial Recording Complete](https://docs.vogent.ai/developers/webhooks/dial-recording)[Dial Transcript Finalized](https://docs.vogent.ai/developers/webhooks/dial-transcript)
⌘I
