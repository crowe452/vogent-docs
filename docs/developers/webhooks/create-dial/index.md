[Skip to main content](https://docs.vogent.ai/developers/webhooks/create-dial#content-area)
...
On this page
  * [Event Type](https://docs.vogent.ai/developers/webhooks/create-dial#event-type)
  * [Payload](https://docs.vogent.ai/developers/webhooks/create-dial#payload)
  * [Example Message](https://docs.vogent.ai/developers/webhooks/create-dial#example-message)
...
## 
[​](https://docs.vogent.ai/developers/webhooks/create-dial#event-type)
Event Type
`dial.created`
## 
[​](https://docs.vogent.ai/developers/webhooks/create-dial#payload)
Payload
...
## 
[​](https://docs.vogent.ai/developers/webhooks/create-dial#example-message)
Example Message
Copy
```
{
