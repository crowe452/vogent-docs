...
```
`curl --request GET \ --url https://api.vogent.ai/api/functions/{id} \ --header 'Authorization: Bearer <token>'`
```
...
[Create a function](/api-reference/create-a-function)[Update function](/api-reference/update-function)