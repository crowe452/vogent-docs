[Skip to main content](http://docs.vogent.ai/platform-overview/api-keys#content-area)
...
[Overview](http://docs.vogent.ai/platform-overview/agents/overview)[API Settings](http://docs.vogent.ai/platform-overview/api-settings)[Web SDK](http://docs.vogent.ai/sdk/web-sdk#use-public-api-keys)
⌘I
