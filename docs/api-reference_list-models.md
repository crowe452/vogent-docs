[Skip to main content](http://docs.vogent.ai/api-reference/list-models#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/list-models#authorization-authorization)
Authorization
string
header
required
...
#### Query Parameters
[​](http://docs.vogent.ai/api-reference/list-models#parameter-limit)
limit
integer
default:100
The maximum number of records to fetch.
[​](http://docs.vogent.ai/api-reference/list-models#parameter-cursor)
cursor
string
...
[​](http://docs.vogent.ai/api-reference/list-models#response-data)
data
object[]
required
Show child attributes
[​](http://docs.vogent.ai/api-reference/list-models#response-cursor-one-of-0)
cursor
string | null
required
A cursor you can pass to /agents to fetch the next page. If no next page exists, the cursor will be null.
[Delete function](http://docs.vogent.ai/api-reference/delete-function)[Run TTS Model](http://docs.vogent.ai/api-reference/run-tts-model)
⌘I
