[Skip to main content](http://docs.vogent.ai/api-reference/update-versioned-prompt#content-area)
...
#### Authorizations
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#authorization-authorization)
Authorization
string
header
required
...
#### Path Parameters
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#parameter-agent-id)
agentId
string
required
ID of the agent.
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#parameter-id)
id
string
required
...
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#body-ai-model-id)
aiModelId
string
The ID of the model to use.
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#body-agent-type)
agentType
enum<string>
...
`STANDARD`, 
`CUSTOM_FLOW`
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#body-prompt)
prompt
string
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#body-flow-definition)
flowDefinition
object
For agents with agentType CUSTOM_FLOW, the flow definition that you want to use.
Show child attributes
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#body-name)
name
string
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#body-model-option-values)
modelOptionValues
object[]
Show child attributes
#### Response
...
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#response-id)
id
string
required
Unique identifier for the versioned prompt
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#response-name)
name
string
required
Human-readable name for the versioned prompt
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#response-agent-type)
agentType
enum<string>
required
...
`STANDARD`, 
`CUSTOM_FLOW`
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#response-prompt-one-of-0)
prompt
string | null
required
The actual prompt content that will be used by the agent. Can be null for CUSTOM_FLOW agent types
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#response-flow-definition-one-of-0)
flowDefinition
object
The flow definition for the agent. Only defined for CUSTOM_FLOW agent types.
Show child attributes
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#response-ai-model-id)
aiModelId
string
The AI model ID to use for the agent.
[​](http://docs.vogent.ai/api-reference/update-versioned-prompt#response-model-option-values)
modelOptionValues
object[]
Show child attributes
[Get versioned prompt](http://docs.vogent.ai/api-reference/get-versioned-prompt)[Create versioned prompt](http://docs.vogent.ai/api-reference/create-versioned-prompt)
⌘I
