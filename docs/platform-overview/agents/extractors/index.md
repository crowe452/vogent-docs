[Skip to main content](https://docs.vogent.ai/platform-overview/agents/extractors#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[Extractors](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#extractors)[List extractors](https://docs.vogent.ai/api-reference/list-extractors)
⌘I
