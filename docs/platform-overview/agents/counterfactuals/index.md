[Skip to main content](https://docs.vogent.ai/platform-overview/agents/counterfactuals#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[Dial History](https://docs.vogent.ai/platform-overview/agents/evaluation/dial-history#counterfactuals)[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)
⌘I
