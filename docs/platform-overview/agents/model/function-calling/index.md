[Skip to main content](https://docs.vogent.ai/platform-overview/agents/model/function-calling#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[Function Calling](https://docs.vogent.ai/platform-overview/tools/function-calling)[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)
⌘I
Assistant
