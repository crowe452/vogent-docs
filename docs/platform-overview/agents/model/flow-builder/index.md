[Skip to main content](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#content-area)
...
On this page
  * [Building an Agent with Flow Builder](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#building-an-agent-with-flow-builder)
  * [Understanding the Flow Builder](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#understanding-the-flow-builder)
  * [Adding Nodes](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#adding-nodes)
  * [Question Nodes](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#question-nodes)
  * [Freeform Nodes](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#freeform-nodes)
  * [Function Call Nodes](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#function-call-nodes)
  * [Connecting Nodes](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#connecting-nodes)
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#building-an-agent-with-flow-builder)
...
### 
[​](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#understanding-the-flow-builder)
...
### 
[​](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#adding-nodes)
Adding Nodes
...
#### 
[​](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#question-nodes)
Question Nodes
...
#### 
[​](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#freeform-nodes)
Freeform Nodes
...
#### 
[​](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#function-call-nodes)
Function Call Nodes
In a function call node, the agent will call an external function to get a response, which it can then use in future nodes. For more information on function-calling in Vogent, see the [Function Calling](https://docs.vogent.ai/platform-overview/agents/model/function-calling) guide.
For any node, you can reference past nodes by using `@` to insert a variable.
### 
[​](https://docs.vogent.ai/platform-overview/agents/model/flow-builder#connecting-nodes)
Connecting Nodes
...
[Prompted Models](https://docs.vogent.ai/platform-overview/agents/model/prompted-models)[Fine Tuning](https://docs.vogent.ai/platform-overview/agents/model/fine-tuning)
⌘I
