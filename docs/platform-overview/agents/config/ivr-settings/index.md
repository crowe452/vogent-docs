[Skip to main content](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#content-area)
...
On this page
  * [IVR Detection](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#ivr-detection)
  * [Voice Settings](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#voice-settings)
  * [Model Selection](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#model-selection)
  * [Tag Text](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#tag-text)
  * [Best Practices](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#best-practices)
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#ivr-detection)
IVR Detection
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#voice-settings)
Voice Settings
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#model-selection)
Model Selection
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#tag-text)
Tag Text
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/config/ivr-settings#best-practices)
Best Practices
...
[Linked Numbers](https://docs.vogent.ai/platform-overview/agents/config/linked-numbers)[Overview](https://docs.vogent.ai/platform-overview/agents/model/overview)
⌘I
