[Skip to main content](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#content-area)
...
On this page
  * [Creating an Extractor](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#creating-an-extractor)
  * [General Settings](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#general-settings)
  * [Extraction Fields](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#extraction-fields)
  * [Testing Extractors](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#testing-extractors)
  * [Managing Versions](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#managing-versions)
  * [Best Practices](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#best-practices)
  * [Technical Details](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#technical-details)


Post-Call Analysis
# Extractors
Extract data after each call in a structured format
Extractors enable you to gather structured data after each call. You can then use this data to interface with your own systems or track performance over time. For example, in our quickstart guide’s [Restaurant Ordering Agent](https://docs.vogent.ai/quickstart/inbound#retrieving-the-order-post-call), we use extractors to gather the customer’s name and order in a consistent format, which we can then use to e.g. hit a point-of-sale system’s API reliably. While you can view all extractor results in the UI, you can also use the [Dial Extractor webhook](https://docs.vogent.ai/webhooks/dial-extractor) to send the data to your own systems after each call.
## 
[​](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#creating-an-extractor)
...
### 
[​](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#general-settings)
General Settings
Each extractor version needs a name that will be used to identify it in the UI.
### 
[​](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#extraction-fields)
Extraction Fields
...
### 
[​](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#testing-extractors)
Testing Extractors
...
3
Select Dial
Provide the Dial ID of the dial that you’d like to test against (check out the [Dial History](https://docs.vogent.ai/platform-overview/agents/evaluation/dial-history) section to learn about browsing past dials)
4
Run Extractor
Click **Test** to run the extractor on this dial. It may take a few seconds to complete.
### 
[​](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#managing-versions)
Managing Versions
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#best-practices)
Best Practices
...
## 
[​](https://docs.vogent.ai/platform-overview/agents/evaluation/extractors#technical-details)
Technical Details
...
[Overview](https://docs.vogent.ai/platform-overview/agents/evaluation/overview)[Dial History](https://docs.vogent.ai/platform-overview/agents/evaluation/dial-history)
⌘I
