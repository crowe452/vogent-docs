[Skip to main content](https://docs.vogent.ai/platform-overview/agents/evaluation/counterfactuals#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[Dial History](https://docs.vogent.ai/platform-overview/agents/evaluation/dial-history#counterfactuals)[Versioning and Evaluation](https://docs.vogent.ai/platform-overview/agents/evaluation/versioning-and-evaluation#versioning-and-evaluation)
⌘I
