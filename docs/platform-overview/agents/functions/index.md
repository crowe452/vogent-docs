[Skip to main content](https://docs.vogent.ai/platform-overview/agents/functions#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)[Outbound Agent Quickstart](https://docs.vogent.ai/quickstart/outbound#outbound-agent-quickstart)
⌘I
