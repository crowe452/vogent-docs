[Skip to main content](https://docs.vogent.ai/platform-overview/self-learning/overview#content-area)
...
Self Learning
# Self Learning Overview
Using the self-learning capabilities in Vogent
Using self-learning, you can automatically create agents from recordings and talk tracks, while also having them learn from their own conversations to improve their performance.
## [Auto-CreateCreate your agent from recordings and talk tracks](https://docs.vogent.ai/platform-overview/self-learning/create)## [OptimizeAuto-improve your agent’s performance based on historical dials and simulations](https://docs.vogent.ai/platform-overview/self-learning/optimize)
[Using a SIP Domain](https://docs.vogent.ai/telephony/sip-domain/overview)[Auto-Create Agents](https://docs.vogent.ai/platform-overview/self-learning/create)
⌘I
