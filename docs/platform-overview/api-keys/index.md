[Skip to main content](https://docs.vogent.ai/platform-overview/api-keys#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[API Settings](https://docs.vogent.ai/platform-overview/api-settings)[Web SDK](https://docs.vogent.ai/sdk/web-sdk#use-public-api-keys)
⌘I
Assistant
