[Skip to main content](https://docs.vogent.ai/platform-overview/telephony#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[SIP Trunking Overview](https://docs.vogent.ai/telephony/sip/overview#sip-trunking-overview)[Introduction](https://docs.vogent.ai/platform-overview/introduction)
⌘I
