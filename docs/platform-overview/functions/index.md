[Skip to main content](https://docs.vogent.ai/platform-overview/functions#content-area)
...
[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[SIP Trunking Overview](https://docs.vogent.ai/telephony/sip/overview#sip-trunking-overview)[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound#conclusion)
⌘I
