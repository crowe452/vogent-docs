[Skip to main content](https://docs.vogent.ai/platform-overview/how-vogent-works#content-area)
...
[SIP Trunking Overview](https://docs.vogent.ai/telephony/sip/overview#sip-trunking-overview)[Overview](https://docs.vogent.ai/platform-overview/agents/overview)[Introduction](https://docs.vogent.ai/introduction#introduction)
⌘I
