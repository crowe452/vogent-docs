[Skip to main content](https://docs.vogent.ai/platform-overview/tools/function-calling#content-area)
...
On this page
  * [Defining a function](https://docs.vogent.ai/platform-overview/tools/function-calling#defining-a-function)
  * [API](https://docs.vogent.ai/platform-overview/tools/function-calling#api)
  * [Configuration](https://docs.vogent.ai/platform-overview/tools/function-calling#configuration)
  * [Knowledge Base](https://docs.vogent.ai/platform-overview/tools/function-calling#knowledge-base)
  * [Configuration](https://docs.vogent.ai/platform-overview/tools/function-calling#configuration-2)
  * [Function Schema](https://docs.vogent.ai/platform-overview/tools/function-calling#function-schema)
  * [Call Transfer](https://docs.vogent.ai/platform-overview/tools/function-calling#call-transfer)
  * [Configuration](https://docs.vogent.ai/platform-overview/tools/function-calling#configuration-3)
  * [Function Schema](https://docs.vogent.ai/platform-overview/tools/function-calling#function-schema-2)
  * [Example Usage](https://docs.vogent.ai/platform-overview/tools/function-calling#example-usage)
...
## 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#defining-a-function)
Defining a function
When you create a function in the **Functions** tab, you’ll have a few different options for defining it.
### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#api)
API
...
#### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#configuration)
Configuration
1
...
### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#knowledge-base)
Knowledge Base
...
#### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#configuration-2)
Configuration
1
Select function type
...
#### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#function-schema)
Function Schema
...
Make sure you’ve uploaded and indexed your documents in the Knowledge Base section before creating a knowledge base function. For more information on how knowledge bases work in Vogent, check out our [knowledge base guide](https://docs.vogent.ai/platform-overview/tools/knowledge-bases).
### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#call-transfer)
Call Transfer
...
#### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#configuration-3)
Configuration
...
#### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#function-schema-2)
Function Schema
...
#### 
[​](https://docs.vogent.ai/platform-overview/tools/function-calling#example-usage)
Example Usage
...
[Voice Cloning](https://docs.vogent.ai/platform-overview/voices/voice-cloning)[Knowledge Bases](https://docs.vogent.ai/platform-overview/tools/knowledge-bases)
⌘I
