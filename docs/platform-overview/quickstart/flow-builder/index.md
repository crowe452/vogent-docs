[Skip to main content](https://docs.vogent.ai/platform-overview/quickstart/flow-builder#content-area)
...
[Flow Builder Agent Quickstart](https://docs.vogent.ai/quickstart/flow-builder)[Inbound Agent Quickstart](https://docs.vogent.ai/quickstart/inbound#inbound-agent-quickstart)[Outbound Agent Quickstart](https://docs.vogent.ai/quickstart/outbound#outbound-agent-quickstart)
⌘I
Assistant
