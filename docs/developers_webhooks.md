[Skip to main content](http://docs.vogent.ai/developers/webhooks#content-area)
...
On this page
  * [Event Type](http://docs.vogent.ai/developers/webhooks#event-type)
  * [Payload](http://docs.vogent.ai/developers/webhooks#payload)
  * [Example Message](http://docs.vogent.ai/developers/webhooks#example-message)
...
## 
[​](http://docs.vogent.ai/developers/webhooks#event-type)
Event Type
`dial.created`
## 
[​](http://docs.vogent.ai/developers/webhooks#payload)
Payload
...
## 
[​](http://docs.vogent.ai/developers/webhooks#example-message)
Example Message
Copy
```
{
